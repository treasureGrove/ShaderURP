...
Shader "M_Master"
{
	Properties
	{
		...
		[Toggle(_ROUGHNESS_INVERT_ON)] _Roughness_Invert("Roughness_Invert", Float) = 0
		...
		[ASEEnd]_UV_Offset("UV_Offset", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _ROUGHNESS_INVERT_ON
			...
			sampler2D Material_Texture2D_4;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord22 = IN.ase_texcoord8.xy * temp_cast_0 + _UV_Offset;
				float4 tex2DNode1 = tex2D( Material_Texture2D_1, texCoord22 );
				float2 uvMaterial_Texture2D_4 = IN.ase_texcoord8.xy * Material_Texture2D_4_ST.xy + Material_Texture2D_4_ST.zw;
				...
				float3 break10 = UnpackNormalScale( tex2D( Material_Texture2D_0, texCoord22 ), 1.0f );
				...
				float4 tex2DNode3 = tex2D( Material_Texture2D_2, texCoord22 );
				#ifdef _ROUGHNESS_INVERT_ON
				float staticSwitch33 = ( 1.0 - tex2DNode3.r );
				#else
				float staticSwitch33 = tex2DNode3.r;
				#endif
				#ifdef _ROUGHNESS_ALPHA_ON
				float staticSwitch25 = ( tex2DNode1.a * _Roughness );
				#else
				float staticSwitch25 = ( staticSwitch33 * _Roughness );
				#endif
				

				float3 BaseColor = desaturateVar27;
				float3 Normal = appendResult11.xyz;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_UV).xx;
				float2 texCoord22 = IN.ase_texcoord4.xy * temp_cast_0 + _UV_Offset;
				float4 tex2DNode1 = tex2D( Material_Texture2D_1, texCoord22 );
				float2 uvMaterial_Texture2D_4 = IN.ase_texcoord4.xy * Material_Texture2D_4_ST.xy + Material_Texture2D_4_ST.zw;
				float4 tex2DNode17 = tex2D( Material_Texture2D_4, uvMaterial_Texture2D_4 );
				#ifdef _MASKINVERT_ON
				float staticSwitch20 = ( 1.0 - tex2DNode17.r );
				#else
				...
				float staticSwitch29 = 0.0;
				#endif
				float3 temp_cast_2 = (staticSwitch29).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_UV).xx;
				float2 texCoord22 = IN.ase_texcoord2.xy * temp_cast_0 + _UV_Offset;
				float4 tex2DNode1 = tex2D( Material_Texture2D_1, texCoord22 );
				float2 uvMaterial_Texture2D_4 = IN.ase_texcoord2.xy * Material_Texture2D_4_ST.xy + Material_Texture2D_4_ST.zw;
				float4 tex2DNode17 = tex2D( Material_Texture2D_4, uvMaterial_Texture2D_4 );
				#ifdef _MASKINVERT_ON
				float staticSwitch20 = ( 1.0 - tex2DNode17.r );
				#else
...
/*ASEBEGIN
Version=19107
Node;AmplifyShaderEditor.RangedFloatNode;23;-3296.259,-427.3929;Inherit;False;Property;_UV;UV;12;0;Create;True;0;0;0;False;0;False;1;1;0.1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;32;-3140.022,-217.5267;Inherit;False;Property;_UV_Offset;UV_Offset;16;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;17;-2504.367,-19.21308;Inherit;True;Property;Material_Texture2D_4;Mask;5;0;Create;False;0;0;0;False;0;False;-1;abc00000000000149353655522420383;abc00000000000149353655522420383;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-2304.903,-878.1303;Inherit;True;Property;Material_Texture2D_1;Albedo;0;0;Create;False;0;0;0;False;0;False;-1;f8232031c2875ce41b3cda7976f1e946;f8232031c2875ce41b3cda7976f1e946;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;21;-2097.731,250.0792;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;15;-2193.004,-322.0078;Inherit;False;Property;_Color;Color;14;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;20;-2023.605,49.70701;Inherit;False;Property;_MaskInvert;MaskInvert;13;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-1166.801,184.8999;Inherit;True;Property;Material_Texture2D_0;Normal;1;0;Create;False;0;0;0;False;0;False;-1;abc00000000007042257557727383858;abc00000000005546889098118452484;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1092.5,-128.6;Inherit;False;Property;_Brightness;Brightness;4;0;Create;True;0;0;0;False;0;False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-872.4393,49.66666;Inherit;False;Property;_Invert;Invert;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-642.3318,-79.46907;Inherit;False;Property;_Desaturation;Desaturation;15;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;30;-792.5969,881.4632;Inherit;True;Property;Material_TextureD_3;Emissive;3;0;Create;False;0;0;0;False;0;False;-1;6474a2f4eef37964d94f1a0dd8ee21ec;6474a2f4eef37964d94f1a0dd8ee21ec;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;35;4;25;0
ASEEND*/
//CHKSM=09F50B5143996A31A8A7E3430F8F475EEFAA233E